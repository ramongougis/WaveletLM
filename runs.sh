...
# MBS-64 fit is probed immediately). Fixed C=512 / L=10, fully spectral, at MBS=64 — bumped from
...
# the width law predicted (1.041) — C=512 punches above the curve. VRAM: K4 used 5,517 MiB at
# MBS=8 -> MBS=64 est ~27GB on the 32GB 5090 — TIGHT. D0 is the cheap probe: if it OOMs in minute 1,
# fall back ALL rungs to MBS=48 (lr 0.19) or 32 (lr 0.16) and restart the ladder so rungs stay
# protocol-matched. lr=0.22 = sqrt(8)-scaled from the 48/C-rule 0.094, held under the naive 0.265
# (NaN cliff is width-bound). min_lr = lr/50. eval_interval=500 (~7.3K steps/epoch at MBS=64).
...
# D3 ~52h (cancellable).
run_ablation "D0_C512_L10_fs_MBS64_5ep D-ladder 0/3 — C=512 fully spectral, MBS=64 probe + control (5ep)"     "$BASE_PATCH_5EP"     '{"levels": 7, "per_scale_mixer_widths": [1.0, 1.0, 1.0, 1.0, 0.5, 0.5, 0.5, 0.5], "wavelet_crawl": true, "wavelet_crawl_k": 33, "wavelet_decomp_norm": true, "wavelet_recon_norm": true, "lr": 0.22, "min_lr": 0.0044, "micro_batch_size": 64, "eval_interval": 500, "wavelet_basis": "real", "mixer_transform": "identity", "mlp_expansion": 0, "skip_proj_out": true, "dropout_embedding": 0.18, "dropout_projection": 0.09, "dropout_mixer": 0.09, "dropout_mlp": 0.10, "dropout_lm_head": 0.216, "weight_decay": 2e-6, "fwpkm_enabled": false, "gradient_checkpointing": false, "layers": 10, "C": 512}'     "D0_C512_L10_fs_MBS64_5ep: D-ladder control + MBS-64 VRAM probe (~27GB est — tight); A/B vs K4 MBS-8 1.0365 (batch effect at C=512); if OOM fall back 48 (lr 0.19) / 32 (lr 0.16) + restart ladder"
run_ablation "D1_C512_L10_fs_MBS64_10ep D-ladder 1/3 — C=512 fully spectral (10ep)"     "$BASE_PATCH_5EP"     '{"epochs": 10, "levels": 7, "per_scale_mixer_widths": [1.0, 1.0, 1.0, 1.0, 0.5, 0.5, 0.5, 0.5], "wavelet_crawl": true, "wavelet_crawl_k": 33, "wavelet_decomp_norm": true, "wavelet_recon_norm": true, "lr": 0.22, "min_lr": 0.0044, "micro_batch_size": 64, "eval_interval": 500, "wavelet_basis": "real", "mixer_transform": "identity", "mlp_expansion": 0, "skip_proj_out": true, "dropout_embedding": 0.18, "dropout_projection": 0.09, "dropout_mixer": 0.09, "dropout_mlp": 0.10, "dropout_lm_head": 0.216, "weight_decay": 2e-6, "fwpkm_enabled": false, "gradient_checkpointing": false, "layers": 10, "C": 512}'     "D1_C512_L10_fs_MBS64_10ep: D-ladder E=10 (1.31B nominal tokens); watch train/val gap vs D0"
run_ablation "D2_C512_L10_fs_MBS64_20ep D-ladder 2/3 — C=512 fully spectral (20ep)"     "$BASE_PATCH_5EP"     '{"epochs": 20, "levels": 7, "per_scale_mixer_widths": [1.0, 1.0, 1.0, 1.0, 0.5, 0.5, 0.5, 0.5], "wavelet_crawl": true, "wavelet_crawl_k": 33, "wavelet_decomp_norm": true, "wavelet_recon_norm": true, "lr": 0.22, "min_lr": 0.0044, "micro_batch_size": 64, "eval_interval": 500, "wavelet_basis": "real", "mixer_transform": "identity", "mlp_expansion": 0, "skip_proj_out": true, "dropout_embedding": 0.18, "dropout_projection": 0.09, "dropout_mixer": 0.09, "dropout_mlp": 0.10, "dropout_lm_head": 0.216, "weight_decay": 2e-6, "fwpkm_enabled": false, "gradient_checkpointing": false, "layers": 10, "C": 512}'     "D2_C512_L10_fs_MBS64_20ep: D-ladder E=20 (2.62B nominal); THE prediction-scoring rung — ~0.97-1.00 est, coin-flip vs SP1 0.9805; ties/beats = 73M matches the 239M flagship"
run_ablation "D3_C512_L10_fs_MBS64_40ep D-ladder 3/3 — C=512 fully spectral (40ep)"     "$BASE_PATCH_5EP"     '{"epochs": 40, "levels": 7, "per_scale_mixer_widths": [1.0, 1.0, 1.0, 1.0, 0.5, 0.5, 0.5, 0.5], "wavelet_crawl": true, "wavelet_crawl_k": 33, "wavelet_decomp_norm": true, "wavelet_recon_norm": true, "lr": 0.22, "min_lr": 0.0044, "micro_batch_size": 64, "eval_interval": 500, "wavelet_basis": "real", "mixer_transform": "identity", "mlp_expansion": 0, "skip_proj_out": true, "dropout_embedding": 0.18, "dropout_projection": 0.09, "dropout_mixer": 0.09, "dropout_mlp": 0.10, "dropout_lm_head": 0.216, "weight_decay": 2e-6, "fwpkm_enabled": false, "gradient_checkpointing": false, "layers": 10, "C": 512}'     "D3_C512_L10_fs_MBS64_40ep: D-ladder E=40 (5.24B nominal — the repeats-decay/overfit stress rung); cancellable if D2 shows the curve has flattened"
# ==============================================================================
