...
| M4  | magnitude   | 10%                  | ~419K                                        | ~14.7M (~87% reduction) | [link](logs/wikitext-103_2026-05-06_07-45-44/log.txt) | 1.2861 | **Identical to M0/M1/M2/M3** (1.2860/1.2861/1.2861/1.2861/1.2861). Four runs across four orders of magnitude in density (0.1% → 10% = 100× span), all landing at exactly 1.2861. Confirms decisively: no sparse subset of off-diagonal positions, of any tested density, recovers anything beyond the pure diagonal. The lifting matrices' off-diagonal mass requires whole-matrix coordination to do its work. |
