...
| BAND256 (pending) | banded | bandwidth=256, 27.63M total | 1.05M | 75% | | | Predicted via BAND≈BD parity: ~76-79% gap recovery, BPB ~1.246-1.249 (similar to predicted BD512). Useful confirmation point but unlikely to outperform BD256 as production default given BD's superior storage / kernel story. |
