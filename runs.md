...
| MON32 (pending) | monarch | nblocks=32, blocks of 64x64 + perfect shuffle | 198K | 95% | | | Lifting ≈ 5.56M total. Tests the lower-n side of the Monarch param-symmetry (R·P·L·P^T params = N·(n + N/n), minimized at n=√N). Pending re-run. |
| MON64 | monarch | nblocks=64, blocks of 32x32 + perfect shuffle | 198K | 95% | [link](logs/wikitext-103_2026-05-07_09-31-54/log.txt) | **1.2615** | Recovers **47.3%** of gap (+0.0254 vs reference 1.2361). At 5.56M lifting (~5% of full) recovers slightly less than BD64 (47.7% at 3.73M) and BAND32 (46.0% at 3.76M) at lower param counts. Per-param efficiency 8.51 pp/M, vs BD64's 12.79 pp/M. The Monarch parameterization (R·P·L·P^T with two perfect-shuffle permutations) at this param tier doesn't unlock cross-channel interactions that BD/BAND can't already approximate. Higher-param Monarchs (MON128, MON256) pending to test whether more capacity changes this. |
| MON128 (pending) | monarch | nblocks=128, blocks of 16x16 + perfect shuffle | 295K | 93% | | | Lifting ≈ 8.27M total. **Closest matched-param-count Monarch to BAND64 (7.34M) and BD128 (7.40M)** — direct test of whether Monarch outperforms BD/BAND at the 6-8M param tier. By Monarch param-symmetry (n=128 has the same param count as n=16). |
| MON256 (pending) | monarch | nblocks=256, blocks of 8x8 + perfect shuffle | 541K | 87% | | | Lifting ≈ 15.17M total. **Closest matched-param-count Monarch to BD256 (14.74M) and BAND128 (14.33M)** — tests Monarch at the production-relevant ~12% density tier. If Monarch doesn't beat BD/BAND here, the structural hypothesis (two-factor product captures interactions BD can't) is rejected at production density. |
