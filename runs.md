...
| MON32 (pending) | monarch | nblocks=32, blocks of 64x64 + perfect shuffle | 198K | 95% | | | Lifting ≈ 5.56M total. Tests whether perfect-shuffle factor product captures cross-channel interactions that BD/BAND can't. If MON ≈ BD/BAND at similar param count (~50% recovery at 5.56M), Monarch is no better than BD. If MON significantly outperforms (60%+ at 5.56M), Monarch becomes a contender for production default. |
| MON64 (pending) | monarch | nblocks=64, blocks of 32x32 + perfect shuffle | 198K | 95% | | | Lifting ≈ 5.56M total (same as MON32 by symmetry of the parameterization). Tests whether finer blocks with the same param count change recovery. |
